    ...
    focusAreas: [
      {
        ...
        description:
          "I build complete, production-ready products from backend to frontend with scalability in mind.",
      },
      {
        title: "Scalable SaaS Architecture",
        description:
          "I design systems that grow gracefully using modern stacks like Next.js and PostgreSQL.",
      },
      {
        title: "AI & Automation",
        description:
          "I integrate AI to automate workflows and create practical user-facing intelligence.",
      },
      {
        title: "Performance & UX",
        description:
          "I focus on speed, clarity, and usability across all devices and screen sizes.",
      },
    ],
  } as const;