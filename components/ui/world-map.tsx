...
interface MapProps {
  ...
  lineColor?: string;
  centralPoint?: { lat: number; lng: number };
  centralPointColor?: string;
}
...
export function WorldMap({
  ...
  return (
    <div className="w-full aspect-[2/1] relative font-sans overflow-hidden">
      ...
      >
        {/* Add central point if provided */}
        {centralPoint && (
          <g key="central-point">
            <circle
              cx={projectPoint(centralPoint.lat, centralPoint.lng).x}
              cy={projectPoint(centralPoint.lat, centralPoint.lng).y}
              r="3"
              fill={centralPointColor}
            />
            <circle
              cx={projectPoint(centralPoint.lat, centralPoint.lng).x}
              cy={projectPoint(centralPoint.lat, centralPoint.lng).y}
